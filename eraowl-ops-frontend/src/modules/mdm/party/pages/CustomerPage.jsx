    ...
    return (
      <div className="h-[calc(100vh-6.5rem)] flex flex-col">
        <div className="flex items-center justify-between px-4 py-3 border-b border-outline-variant">
          <div>
            <h1 className="text-[32px] font-semibold leading-10 tracking-tight text-on-surface">Customers</h1>
            <p className="text-sm text-outline mt-1">{customersLoading ? 'Loading...' : `${customers.length} customer${customers.length !== 1 ? 's' : ''}`}</p>
          </div>
      ...
      <div className="flex items-center justify-between px-4 py-3 border-b border-outline-variant">
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-sm text-outline mt-1">Configure customer details and sites</p>
          </div>
        </div>

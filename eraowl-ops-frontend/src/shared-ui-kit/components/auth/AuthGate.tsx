  ...
  return (
    <div className="flex h-screen w-full items-center justify-center bg-background">
      <div className="flex flex-col items-center gap-6 text-center max-w-sm">
        ...
        <div>
          <h1 className="text-2xl font-bold text-slate-900! dark:text-white!">Axon OS</h1>
          <p className="text-sm text-slate-500! dark:text-slate-300! mt-1">Enterprise Resource Planning</p>
        </div>
